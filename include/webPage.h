...
<body class="">
  ...
  <div class="imageBack_container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.02 64.13">
      <defs>
        <style>
          .cls-1 {
            fill: #fff;
      ...
      function getForecast() {
        fetch(
          ...
          .then((data_) => {
            ...
            $('.weather_widget .close, footer .a_weather').on('click', function () {
  ...
  <div class="ifdata">
    <div class="container-modal unvisible">
      ...
      <div
        ...
        <div class="close noselect bg-white p-10 rounded-xl ring-8 ring-white ring-opacity-40">x</div>
  ...
  <footer>
    ...
    <a href="#" class="usegaz noselect">
      <?xml version="1.0" encoding="UTF-8"?>
      <svg id="Warstwa_1" data-name="Warstwa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362.52 609.29">
        <defs>
          <style>
            .cls-1 {
              fill: #fff;

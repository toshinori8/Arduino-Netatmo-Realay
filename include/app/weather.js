...
let convertTimestamp = (timestamp, type) => {
...
let currentHour = async (data) => {
  ...
  if (data) {
    ...
    html = `<div class="flex flex-col">
        <span class="text-3xl font-bold lcd">${data.current.temp}<span class="text-3xl">°C</span></span>
      ...
      <div class="flex flex-col">
        <span class="text-3xl font-bold lcd">${data.current.humidity.toFixed(0)}<span class="text-3xl"><span
